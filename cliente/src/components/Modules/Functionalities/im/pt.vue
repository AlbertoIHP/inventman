<template>
  <section>
    ...
    <md-dialog md-open-from="#addProvider" md-close-to="#addProvider" ref="addProvider">
      <md-dialog-title>Agregar Tipo</md-dialog-title>
      ...
      <md-dialog-content>
          ...
          <md-input-container>
            ...
            <md-input type="text"  v-model="newProvider.description"></md-input>
          </md-input-container>
      </md-dialog-content>
    ...
    <md-dialog md-open-from="#addCity" md-close-to="#addCity" ref="editProvider">
      <md-dialog-title>Edicion de Tipo</md-dialog-title>
      ...
      <md-dialog-content>
        ...
        <md-input-container>
          <label>Descripcion del Tipo</label>
          <md-input type="text"  v-model="editProvider.description"></md-input>
        </md-input-container>
...
<script>
  ...
  const servicioProveedor = new ApiConnect('productTypes')
  ...
  export default {
    ...
    data () {
      return {
        providers: [],
        newProvider: {id: 0, name: "", description: ""},
        editProvider: {id: 0, name: "", description: ""}
      }
    },
    methods: {
      obtenerProveedores()
