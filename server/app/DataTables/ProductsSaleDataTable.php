...
class ProductsSaleDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'products_sales.datatables_actions')
            ->make(true);
    }
    ...
    {
        $productsSales = ProductsSale::query();

        return $this->applyScopes($productsSales);
    }
